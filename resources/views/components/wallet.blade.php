 <div class=" w-2/3  bg-white  border shadow-md sm:pt-0 px-5">
     <div class="h-screen grid grid-cols-3">
         <div class="lg:col-span-2 col-span-3 bg-blue-100 space-y-8 px-12">
             ...
             <div class="flex justify-center mt-1">
                 <button
                     class="submit-button mx-2 px-4 py-1 rounded-full bg-blue-400 text-white focus:ring focus:outline-none w-1/2 text-xl font-semibold transition-colors">
                     Top Up
                 </button>
                 <button
                     class="submit-button mx-2 px-4 py-1 rounded-full bg-blue-400 text-white focus:ring focus:outline-none w-1/2 text-xl font-semibold transition-colors">
             ...
             <ul class="my-4 space-y-3">
                 <li>
                     <a href="#"
                         ...
                         <span
                             class="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500">Popular</span>
                     </a>
                 </li>
             </ul>
             <div>
                 ...
                 <li class="flex gap-2 border-b-1 justify-items-center items-end">
                     ...
                     <div class="w-1/3 pt-3 ml-2">
                         <div class="flex  space-x-2 text-xs justify-between">
                             <span class="text-blue-400 font-semibold inline-block">₱ 5,349</span>
                         </div>
                     </div>
                 </li>
                 <li class="flex gap-2 border-b-1 justify-items-center items-end">
                     ...
                     <div class="w-1/3 pt-3 ml-2">
                         <div class="flex  space-x-2 text-xs justify-between">
                             <span class="text-blue-400 font-semibold inline-block">₱ 79</span>
                         </div>
                     </div>
                 </li>
                 <li class="flex gap-2 border-b-1 justify-items-center items-end">
                     ...
                     <div class="w-1/3 pt-3 ml-2">
                         <div class="flex  space-x-2 text-xs justify-between">
                             <span class="text-blue-400 font-semibold inline-block">₱ 569</span>
                         </div>
                     </div>
                 </li>
             </ul>
