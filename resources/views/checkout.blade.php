<x-head-customer>Reservoir | Checkout</x-head>
    <x-layout>
        ...
        <div class="h-screen px-48 grid grid-cols-3">
            <div class="lg:col-span-2 col-span-3 bg-indigo-50 space-y-8 px-12">
                ...
                <button
                    class="submit-button px-4 py-3 rounded-full bg-teal-500 text-white focus:ring focus:outline-none w-full text-xl font-semibold transition-colors">
                    Pay €846.98
                </button>
            </div>
            <div class="col-span-1 bg-white lg:block hidden">
                    ...
                    <li class="grid grid-cols-6 gap-2 border-b-1">
                        ...
                        <div class="col-span-2 pt-3">
                            <div class="flex items-center space-x-2 text-sm justify-between">
                                ...
                                <span class="text-teal-400 font-semibold inline-block">€61.98</span>
                            </div>
                        </div>
                    </li>
                    <li class="grid grid-cols-6 gap-2 border-b-1">
                        ...
                        <div class="col-span-2 pt-3">
                            <div class="flex items-center space-x-2 text-sm justify-between">
                                ...
                                <span class="text-teal-400 font-semibold inline-block">€785</span>
                            </div>
                        </div>
                    </li>
                </ul>
                <div class="px-8 border-b">
                    <div class="flex justify-between py-4 text-gray-600">
                        <span>Subtotal</span>
                        <span class="font-semibold text-teal-500">€846.98</span>
                    </div>
                    <div class="flex justify-between py-4 text-gray-600">
                        <span>Shipping</span>
