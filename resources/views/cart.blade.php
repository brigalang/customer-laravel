...
<div class="flex justify-center my-6">
    <div class="flex flex-col w-full p-8 text-gray-800 bg-white drop-shadow-2xl pin-r pin-y md:w-4/5 lg:w-4/5">
      <div class="flex-1">
                ...
                <form action="" method="POST">
                    <div class="flex items-center w-full h-13 pl-3 bg-white bg-gray-100 border rounded-full">
                      <input type="coupon" name="code" id="coupon" placeholder="Apply coupon" value="90off"
                        ...
                        <button type="submit" class="text-sm flex items-center px-3 py-1 text-white bg-teal-800 rounded-full outline-none md:px-4 hover:bg-gray-700 focus:outline-none active:outline-none">
            ...
            <div class="p-4">
              <p class="mb-6 italic">Shipping and additionnal costs are calculated based on values you have entered</p>
                <div class="flex justify-between border-b">
                  <div class="lg:px-4 lg:py-1 m-1 text-base lg:text-lg font-bold text-center text-gray-800">
                    Subtotal
                  </div>
                  <div class="lg:px-4 lg:py-1 m-1 lg:text-base font-bold text-center text-gray-900">
                    148,827.53€
                  </div>
                </div>
                  <div class="flex justify-between pt-4 border-b">
                    <div class="flex lg:px-4 lg:py-1 m-1 text-base lg:text-lg font-bold text-gray-800">
                      <form action="" method="POST">
                    ...
                    <div class="lg:px-4 lg:py-1 m-1 lg:text-base font-bold text-center text-green-700">
                      -133,944.77€
                    </div>
                  </div>
                  <div class="flex justify-between pt-4 border-b">
                ...
                <a href="/checkout">
                  <button class="flex justify-center w-fit px-20 py-3 mt-6 text-base text-white uppercase bg-teal-800 rounded-full shadow item-center hover:bg-gray-700 focus:shadow-outline focus:outline-none">
